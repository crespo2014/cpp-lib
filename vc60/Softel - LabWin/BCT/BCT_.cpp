// BCT_.cpp: implementation of the CBCT class.
//
//////////////////////////////////////////////////////////////////////
...
DWORD CBCT::ProcessData(BYTE *lpData, DWORD dwSize)
{
	DWORD i;
	for (i=0;i<dwSize;i++)
	{
