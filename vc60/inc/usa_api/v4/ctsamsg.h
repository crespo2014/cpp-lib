...
#define DATA_COMP_CTSAMSG_C            ctsms16
#define DATA_COMP_CTSAMSG__            ctsms17
#endif
...
#ifdef CTSAMSG_C 
void DATA_COMP_CTSAMSG_C (void);
void DATA_COMP_CTSAMSG__ (char * FilePtr, char * TimeStampPtr, int * LinePtr);
void DATA_COMP_CTSAMSG__ (char * FilePtr, char * TimeStampPtr, int * LinePtr)
{
          *LinePtr     = __LINE__;
