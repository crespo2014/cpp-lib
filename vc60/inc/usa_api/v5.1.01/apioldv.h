...
/********************************************************************
 * Procedure Name : CTSPMApiVersion                                 *
 * Description    : Version of PM API used to compile PM            *
 * Input          : None                                            *
 * Output         : version - API version - 4.0.0 etc.              *
 * Return Value   : ESA_RC                                          *
 ********************************************************************/

typedef ESA_RC PMAPIVERSION_FUNC_TYP (RSS_vers_typ  version);

extern  PMAPIVERSION_FUNC_TYP   CTSPMApiVersion;    /* actual function */

typedef PMAPIVERSION_FUNC_TYP * PMAPIVERSION_FUNC_PTR;/*pointer to func */
