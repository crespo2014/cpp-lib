 ...
 * CAR00038176	AjayV	17/07/08	Support to UTF-8 encoding in Online Interceptor.
 ********************************************************************/
...
ChangeMsg *ChangeMsg_ToUTF8(const ChangeMsg *msg);		//CAR00038176

void ChangeMsg_ToUpper(const ChangeMsg *msg);
