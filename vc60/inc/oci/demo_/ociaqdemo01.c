#ifdef RCSID
static char *RCSid =
   "$Header: ociaqdemo01.c 23-sep-99.11:27:29 bnainani Exp $ ";
#endif /* RCSID */
...
void clean_up(envhp, svchp, srvhp, errhp, stmthp, usrhp, deqopt, mesg)
OCIEnv *envhp;
OCIServer *srvhp;
OCIError *errhp;
OCISvcCtx *svchp;
...
int main()
{
    ...
    while(1)
    {
        ...
        checkerr(errhp, OCIBindByName(stmthp, &bndhp[1], errhp,
            (text *) ":city", -1, (dvoid *)city, strlen(city)+1,
