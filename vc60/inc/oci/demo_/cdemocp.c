...
/*
   ...
   DESCRIPTION
     ...
     This demo needs the cdemocp.sql file for creating Pool user. 
     Before running this demo the cdemocp.sql should be executed.
...
static CONST OraText *password =(OraText *)"TIGER";
...
static void threadFunction (dvoid *arg)
{
    ...
    checkerr(errhp, OCIStmtPrepare (stmthp, errhp, (CONST OraText *)insertst1,
