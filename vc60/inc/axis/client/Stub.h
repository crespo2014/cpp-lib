...
/**
    ...
    *                 use 0.
    */
AXISC_STORAGE_CLASS_INFO void axiscSetTransportTimeout(AXISCHANDLE stub, long lSeconds);
...
/**
    ...
    */
AXISC_STORAGE_CLASS_INFO void axiscSetProxyUsername(AXISCHANDLE stub, const char * pcProxyUsername);

/**
    * Sets the password to be used for Proxy authentication
    */
AXISC_STORAGE_CLASS_INFO void axiscSetProxyPassword(AXISCHANDLE stub, const char * pcProxyPassword);

/**
    * Gets the username used for Proxy authentication
    */
AXISC_STORAGE_CLASS_INFO const char * axiscGetProxyUsername(AXISCHANDLE stub);

/**
    * Gets the password used for Proxy authentication
    */
AXISC_STORAGE_CLASS_INFO const char * axiscGetProxyPassword(AXISCHANDLE stub);
...
/**
	 ...
	 */
AXISC_STORAGE_CLASS_INFO AXISCHANDLE axiscCreateSoapAttachmentStub(AXISCHANDLE stub);

/**
     * Set SSL configuration properties.
     */
AXISC_STORAGE_CLASS_INFO void axiscSetSecure(AXISCHANDLE stub, char * , 
	... );
...
/**
     ...
     */
AXISC_STORAGE_CLASS_INFO void axiscIncludeSecure(AXISCHANDLE stub);
...
/**
    ...
    */
AXISC_STORAGE_CLASS_INFO void axiscSetProxyAuthorizationHeader(AXISCHANDLE stub);
