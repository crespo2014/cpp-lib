...
/*
	Hay que incluir la libreria  _Wldap32.lib si se obtiene un acces violation, 
	porque la version del VS60 no vale 
*/

/*
	Cuando se realiza una busqueda hay que recoger la entidades y luego los atributos
*/
class CbLDAP : public CbObject  
{
public:
	DWORD shearch_s(PCHAR base,ULONG scope, PCHAR filter,PCHAR attrs[], ULONG attrsonly);
