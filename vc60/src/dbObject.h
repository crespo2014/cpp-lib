...
{
public:
	DWORD BindParameter(SQLUSMALLINT index, SQLSMALLINT inout_type,DB_DATA_DEF *data_def);
	DB_DATA_DEF* getDataDef_name(const char* field_name);
	DWORD getString_name(const char *field_name, char *val, DWORD maxsize);
