...
#ifdef OS400 
extern "C" STATUS  LNPUBLIC  DumpOneItem( WORD, WORD, char far *, WORD, void far *, DWORD, void far * );
#else
...
#ifdef OS400
extern "C" STATUS  LNPUBLIC  PrintCompositeBuffer (char FAR *pBuffer, DWORD ItemValueLength,
...
#ifdef OS400
extern "C" STATUS  LNPUBLIC  DumpOneCDRecord( char*, WORD, DWORD, void* );
#else
...
#ifdef OS400
extern "C" STATUS  LNPUBLIC  DumpOneAgentQueryRecord( char*, WORD, DWORD, void* );
#else
...
#ifdef OS400
extern "C" STATUS  LNPUBLIC  DumpOneActionRecord( char*, WORD, DWORD, void* );
#else
...
#ifdef OS400
extern "C" STATUS  LNPUBLIC  DumpOneViewmapDatasetRecord( char*, WORD, DWORD, void* );
#else
...
#ifdef OS400
extern "C" STATUS  LNPUBLIC  DumpOneViewmapLayoutRecord( char*, WORD, DWORD, void* );
#else
